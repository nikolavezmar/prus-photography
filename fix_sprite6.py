    ...
    for i in range(21):
        ...
        for y in range(fh):
            for x in range(fw):
                ...
                # Silhouette is dark AND opaque. 
                # Transparent pixels have pixel[3] == 0. 
                # White background has pixel[0]>200.
                is_silhouette = pixel[0] < 150 and pixel[1] < 150 and pixel[2] < 150 and pixel[3] > 128
